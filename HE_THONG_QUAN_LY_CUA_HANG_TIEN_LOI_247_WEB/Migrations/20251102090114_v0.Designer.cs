            ...
            modelBuilder.Entity("HE_THONG_QUAN_LY_CUA_HANG_TIEN_LOI_247_WEB.Models.BaoCaoTonKho", b =>
                {
                    ...
                    b.Property<int>("TongSoLuongTon")
                        .HasColumnType("int")
                        .HasColumnName("tongSoLuongTon");
            ...
            modelBuilder.Entity("HE_THONG_QUAN_LY_CUA_HANG_TIEN_LOI_247_WEB.Models.ChamCong", b =>
                {
                    ...
                    b.ToTable("ChamCong", "core", t =>
                        {
                            t.HasTrigger("trg_ChamCong_AI_Validate");
                        });
            ...
            modelBuilder.Entity("HE_THONG_QUAN_LY_CUA_HANG_TIEN_LOI_247_WEB.Models.ChiTietDonOnline", b =>
                {
                    ...
                    b.ToTable("ChiTietDonOnline", "core", t =>
                        {
                            t.HasTrigger("trg_CTDON_AIU_UpdateTongTien");

                            t.HasTrigger("trg_CTDON_IOD_SoftDelete_UpdateTongTien");
                        });
            ...
            modelBuilder.Entity("HE_THONG_QUAN_LY_CUA_HANG_TIEN_LOI_247_WEB.Models.ChiTietHoaDonKhuyenMai", b =>
                {
                    ...
                    b.ToTable("ChiTietHoaDonKhuyenMai", "core", t =>
                        {
                            t.HasTrigger("trg_CTHDKM_AIU_UpdateHoaDonNet");

                            t.HasTrigger("trg_CTHDKM_AIU_ValidateAndConsume");

                            t.HasTrigger("trg_CTHDKM_AU_AdjustUsageOnChange");

                            t.HasTrigger("trg_CTHDKM_AU_AdjustUsageOnFlip");

                            t.HasTrigger("trg_CTHDKM_IOD_SoftDelete_AllInOne");
                        });
            ...
            modelBuilder.Entity("HE_THONG_QUAN_LY_CUA_HANG_TIEN_LOI_247_WEB.Models.ChiTietPhieuNhap", b =>
                {
                    ...
                    b.ToTable("ChiTietPhieuNhap", "core", t =>
                        {
                            t.HasTrigger("trg_CTPN_AIU_UpdateTonKho");

                            t.HasTrigger("trg_CTPN_IOD_SoftDelete");
                        });
            ...
            modelBuilder.Entity("HE_THONG_QUAN_LY_CUA_HANG_TIEN_LOI_247_WEB.Models.ChiTietPhieuXuat", b =>
                {
                    ...
                    b.ToTable("ChiTietPhieuXuat", "core", t =>
                        {
                            t.HasTrigger("trg_CTPX_AIU_UpdateTonKho");

                            t.HasTrigger("trg_CTPX_IOD_SoftDelete");
                        });
            ...
            modelBuilder.Entity("HE_THONG_QUAN_LY_CUA_HANG_TIEN_LOI_247_WEB.Models.ChuongTrinhKhuyenMai", b =>
                {
                    ...
                    b.ToTable("ChuongTrinhKhuyenMai", "core", t =>
                        {
                            t.HasTrigger("trg_CTKM_AUD");
                        });
            ...
            modelBuilder.Entity("HE_THONG_QUAN_LY_CUA_HANG_TIEN_LOI_247_WEB.Models.DonGiaoHang", b =>
                {
                    ...
                    b.ToTable("DonGiaoHang", "core", t =>
                        {
                            t.HasTrigger("trg_DGH_AU_LogTrangThai");
                        });
            ...
            modelBuilder.Entity("HE_THONG_QUAN_LY_CUA_HANG_TIEN_LOI_247_WEB.Models.DonHangOnline", b =>
                {
                    ...
                    b.ToTable("DonHangOnline", "core", t =>
                        {
                            t.HasTrigger("trg_DHO_AI_LogCreated");
                        });
            ...
            modelBuilder.Entity("HE_THONG_QUAN_LY_CUA_HANG_TIEN_LOI_247_WEB.Models.GiaoDichThanhToan", b =>
                {
                    ...
                    b.ToTable("GiaoDichThanhToan", "core", t =>
                        {
                            t.HasTrigger("trg_GDTT_AI_LogPaidToDHO");
                        });
            ...
            modelBuilder.Entity("HE_THONG_QUAN_LY_CUA_HANG_TIEN_LOI_247_WEB.Models.HoaDon", b =>
                {
                    ...
                    b.ToTable("HoaDon", "core", t =>
                        {
                            t.HasTrigger("trg_HD_AU_AddLoyaltyPoints");
                        });
            ...
            modelBuilder.Entity("HE_THONG_QUAN_LY_CUA_HANG_TIEN_LOI_247_WEB.Models.KenhThanhToan", b =>
                {
                    ...
                    b.ToTable("KenhThanhToan", "core", t =>
                        {
                            t.HasTrigger("trg_KenhThanhToan_AU_Timestamp");
                        });
            ...
            modelBuilder.Entity("HE_THONG_QUAN_LY_CUA_HANG_TIEN_LOI_247_WEB.Models.LichSuGiaBan", b =>
                {
                    ...
                    b.ToTable("LichSuGiaBan", "core", t =>
                        {
                            t.HasTrigger("trg_LSGB_AIU_SyncGiaBanSPDV");
                        });
            ...
            modelBuilder.Entity("HE_THONG_QUAN_LY_CUA_HANG_TIEN_LOI_247_WEB.Models.MaDinhDanhSanPham", b =>
                {
                    ...
                    b.ToTable("MaDinhDanhSanPham", "core", t =>
                        {
                            t.HasTrigger("trg_MDDSP_AI_AutogenCodes");
                        });
            ...
            modelBuilder.Entity("HE_THONG_QUAN_LY_CUA_HANG_TIEN_LOI_247_WEB.Models.MaKhuyenMai", b =>
                {
                    ...
                    b.ToTable("MaKhuyenMai", "core", t =>
                        {
                            t.HasTrigger("trg_MKM_AUD");
                        });
            ...
            modelBuilder.Entity("HE_THONG_QUAN_LY_CUA_HANG_TIEN_LOI_247_WEB.Models.PhieuDoiTra", b =>
                {
                    ...
                    b.ToTable("PhieuDoiTra", "core", t =>
                        {
                            t.HasTrigger("trg_PDT_AIU_ValidateAndRestock");

                            t.HasTrigger("trg_PDT_IOD_SoftDeleteAndRevertStock");
                        });
            ...
            modelBuilder.Entity("HE_THONG_QUAN_LY_CUA_HANG_TIEN_LOI_247_WEB.Models.TaiKhoan", b =>
                {
                    ...
                    b.ToTable("TaiKhoan", "core", t =>
                        {
                            t.HasTrigger("trg_TaiKhoan_AUD");
                        });
